...
export default function FilterForm({
  ...
  return (
    <form action={action} className="flex flex-col gap-8">
        ...
        right={
          isAutoColorFilter ? null : (
            <button
              type="button"
              onClick={addOption}
              className="rounded-full border border-neutral-300 px-3 py-1.5 text-[12px] font-medium text-neutral-700 hover:bg-neutral-100"
            >
              + 옵션 추가
            </button>
          )
      ...
      >
        {isAutoColorFilter ? (
          <div className="rounded-lg border border-blue-200 bg-blue-50/60 p-4 text-[13px] leading-[1.7] text-blue-900">
          ...
          <p className="rounded-lg border border-dashed border-neutral-300 p-6 text-center text-[13px] text-neutral-400">
              ...
              {options.map((o, i) => (
                ...
                >
                  <label className="flex flex-col">
                    <span className="mb-1.5 flex items-baseline gap-1 text-[12px] font-semibold text-neutral-700">
                  ...
                  <label className="flex flex-col">
                    <span className="mb-1.5 text-[12px] font-semibold text-neutral-700">
                      값 (영문, 선택)
                    </span>
                    <input
                      type="text"
                  ...
                  <button
                    ...
                    className="h-[42px] shrink-0 rounded border border-red-300 px-3 text-[12px] text-red-700 hover:bg-red-50"
                  >
                    삭제
                  </button>
                </li>
      ...
      <div className="flex justify-end gap-2 border-t border-neutral-200 pt-6">
        <Link
          href="/admin/filters"
          className="rounded-full border border-neutral-300 px-5 py-2.5 text-[13px] font-medium text-neutral-700 hover:bg-neutral-100"
        >
          취소
        </Link>
        <button
          type="submit"
          className="rounded-full bg-black px-6 py-2.5 text-[13px] font-bold text-white hover:bg-neutral-800"
        >
          저장
        </button>
      </div>
...
function Field({
  ...
  return (
    <div className="flex-1">
      <label className="mb-1.5 flex items-baseline gap-1 text-[12px] font-semibold text-neutral-700">

      ...
      {!hasColorFilter && (
        <div className="mb-6 flex items-start gap-4 rounded-xl border border-blue-200 bg-blue-50/60 p-4">
          ...
          <div className="flex-1">
            ...
            <p className="mt-1 text-[12.5px] leading-[1.7] text-blue-800">
            ...
            <form action={ensureColorFilter} className="mt-3">
              <button
                type="submit"
                className="rounded-full bg-blue-600 px-4 py-2 text-[12.5px] font-bold text-white hover:bg-blue-700"
              >
                기본 색상 필터 생성하기
              </button>
            </form>

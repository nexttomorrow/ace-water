    ...
    <section ref={ref} className="bg-white py-24">
      <div className="mx-auto max-w-[1200px] px-6">
        <div className="text-center">
          ...
          >
            ACEWATER는 다양한 형태의 파트너와 함께합니다. 가장 잘 맞는 영역을
            골라보세요.
          </p>
        </div>
...
function WhyUs() {
  ...
  return (
    <section
      ref={ref}
      className="bg-gradient-to-b from-neutral-50 to-white py-24"
    >
      <div className="mx-auto max-w-[1200px] px-6">
        <div className="grid grid-cols-1 items-center gap-12 md:grid-cols-2">
          <div>
            ...
            >
              자체 제조 공장, 도색 설비, 디자인 연구소까지 통합된 라인을 갖추고
              있어 어떤 규모의 프로젝트도 단일 창구로 진행할 수 있습니다. 다수의
              관공서·기업과의 납품 이력으로 신뢰성도 검증되었습니다.
            </p>
          </div>
  ...
  const steps = [
    {
      num: "01",
      title: "문의",
      desc: "연락처와 사업 분야, 관심 영역을 보내주세요.",
    },
    {
      num: "02",
      title: "상담",
      desc: "담당자가 1:1 미팅 또는 화상 상담을 진행합니다.",
    },
    {
      num: "03",
      title: "제안",
      desc: "맞춤 견적 / 협력 모델을 제안서로 정리해드립니다.",
    },
    {
      num: "04",
      title: "계약",
      desc: "조건 협의 후 계약 체결, 즉시 프로젝트를 시작합니다.",
    },
  ];
...
function ContactCta() {
  ...
  return (
    <section ref={ref} className="bg-neutral-50 pb-28 pt-16">
      <div className="mx-auto max-w-[1200px] px-6">
        <div
          className={`relative overflow-hidden rounded-1xl bg-gradient-to-br from-blue-600 to-cyan-500 px-8 py-12 md:px-14 md:py-16 transition-all duration-1000 ${
            shown ? "translate-y-0 opacity-100" : "translate-y-6 opacity-0"
          }`}
        >
          <div
          ...
          <div
            aria-hidden
            className="absolute -bottom-24 -left-12 h-80 w-80 rounded-full bg-white/10 blur-3xl"
          />

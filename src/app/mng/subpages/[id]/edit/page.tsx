  ...
  return (
    <div className="mx-auto max-w-2xl px-6 py-12">
      <div className="mb-1 text-[0.75rem] text-neutral-500">
        <Link href="/mng/subpages" className="hover:underline">
          서브페이지 배너 관리
        </Link>
        {' › '}
        <span>{cat.name}</span>
      ...
      {isTopLevel ? (
        <p className="mb-5 rounded-md bg-blue-50 px-3 py-2 text-[0.75rem] leading-[1.7] text-blue-800 ring-1 ring-blue-100">
        ...
        <div className="mb-5 rounded-md bg-amber-50 p-3 text-[0.75rem] text-amber-900 ring-1 ring-amber-100">
          ...
          <div className="mt-2 flex items-start gap-3">
            ...
            <p className="text-[0.75rem] leading-[1.6] text-amber-800">
              자체 배너를 등록하면 이 상속분을 덮어쓰게 됩니다.
            </p>
          </div>
        </div>
      ) : !cat.banner_image_path ? (
        <p className="mb-5 rounded-md bg-amber-50 px-3 py-2 text-[0.75rem] leading-[1.7] text-amber-900 ring-1 ring-amber-100">
      ...
      <form action={action} className="flex flex-col gap-5">
        <label className="flex flex-col text-sm">
          ...
          />
          {bannerImageUrl && (
            <label className="mt-2 inline-flex items-center gap-2 text-[0.75rem] text-neutral-600">

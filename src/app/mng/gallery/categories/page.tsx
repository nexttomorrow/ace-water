  ...
  return (
    <div className="mx-auto max-w-[960px] px-6 py-12">
      <div className="mb-1 text-[0.75rem] text-neutral-500">
        <Link href="/mng/gallery" className="hover:underline">
          시공사례 관리
        </Link>{' '}
        ›
      </div>
      <div className="mb-6 flex items-center justify-between">
        ...
        <Link
          href="/mng/gallery/categories/new"
            ...
            return (
              <li key={c.id} className="flex items-center gap-4 px-5 py-4">
                ...
                <div className="flex-1 min-w-0">
                  <p className="truncate text-[0.875rem] font-semibold">{c.name}</p>
                ...
                <div className="flex shrink-0 items-center gap-1">
                  <Link
                    href={`/mng/gallery/categories/${c.id}/edit`}

            ...
            return (
              ...
              >
                ...
                <div className="px-4 py-3">
                  {slide.eyebrow && (
                    <p className="text-[0.75rem] font-semibold tracking-widest text-neutral-500">
                      {slide.eyebrow}
                    </p>
                  )}
                  <p className="mt-1 line-clamp-2 text-[1rem] font-bold leading-snug">
                    {slide.title}
                  </p>
                  <div className="mt-3 flex gap-2">
                    <Link
                      href={`/mng/hero/${slide.id}/edit`}

  ...
  return (
    <div className="mx-auto max-w-[960px] px-6 py-16">
      <div className="mb-10 text-center">
        <p className="mb-2 text-[0.75rem] font-medium tracking-widest text-neutral-500">PRIVACY POLICY</p>
        <h1 className="text-[1.75rem] font-bold leading-tight md:text-[2.25rem]">개인정보처리방침</h1>
        <div className="mx-auto mt-3 h-[2px] w-10 bg-neutral-900" />
        <p className="mt-4 text-[0.875rem] text-neutral-500">시행일자: 2024년 1월 1일</p>
      </div>

      <div className="space-y-10 text-[0.875rem] leading-7 text-neutral-700">
        <section className="rounded-lg bg-neutral-50 p-6 text-[0.875rem] leading-7 text-neutral-600">
          <p>
        ...
        <section>
          <h2 className="mb-3 text-[1rem] font-bold text-neutral-900">제1조 (개인정보의 처리 목적)</h2>
          <p className="mb-3">
        ...
        <section>
          <h2 className="mb-3 text-[1rem] font-bold text-neutral-900">제2조 (수집하는 개인정보의 항목)</h2>
        ...
        <section>
          <h2 className="mb-3 text-[1rem] font-bold text-neutral-900">제3조 (개인정보의 처리 및 보유기간)</h2>
        ...
        <section>
          <h2 className="mb-3 text-[1rem] font-bold text-neutral-900">제4조 (개인정보의 제3자 제공)</h2>
          <p>
        ...
        <section>
          <h2 className="mb-3 text-[1rem] font-bold text-neutral-900">제5조 (개인정보처리의 위탁)</h2>
          <p className="mb-3">
        ...
        <section>
          <h2 className="mb-3 text-[1rem] font-bold text-neutral-900">제6조 (정보주체의 권리·의무 및 행사방법)</h2>
          <ol className="list-decimal space-y-2 pl-5">
        ...
        <section>
          <h2 className="mb-3 text-[1rem] font-bold text-neutral-900">제7조 (개인정보의 파기)</h2>
          <ol className="list-decimal space-y-2 pl-5">
        ...
        <section>
          <h2 className="mb-3 text-[1rem] font-bold text-neutral-900">제8조 (개인정보의 안전성 확보조치)</h2>
        ...
        <section>
          <h2 className="mb-3 text-[1rem] font-bold text-neutral-900">제9조 (쿠키의 사용)</h2>
          <ol className="list-decimal space-y-2 pl-5">
        ...
        <section>
          <h2 className="mb-3 text-[1rem] font-bold text-neutral-900">제10조 (개인정보 보호책임자)</h2>
          <p className="mb-3">
            회사는 개인정보 처리에 관한 업무를 총괄해서 책임지고, 개인정보 처리와 관련한 정보주체의 불만처리 및
            피해구제 등을 위하여 아래와 같이 개인정보 보호책임자를 지정하고 있습니다.
          </p>
          <div className="rounded-lg bg-neutral-50 p-5 text-[0.875rem] leading-7">
        ...
        <section>
          <h2 className="mb-3 text-[1rem] font-bold text-neutral-900">제11조 (개인정보처리방침의 변경)</h2>
          <p>
        ...
        <section className="border-t border-neutral-200 pt-6 text-[0.875rem] text-neutral-500">
          <p>부칙</p>

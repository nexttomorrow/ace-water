        ...
        <div>
          ...
          <div className="flex items-center gap-3 rounded-lg border border-neutral-200 bg-neutral-50 p-3">
            ...
            <div className="min-w-0 flex-1">
              <p className="truncate text-[0.875rem] font-semibold text-neutral-900">{resource.file_name}</p>
              <p className="text-[0.75rem] text-neutral-500">{formatBytes(resource.file_size)}</p>
            </div>
          </div>
        </div>
